...
namespace Contract.Architecture.Persistence.Model.Sessions
{
    internal class SessionsRepository : ISessionsRepository
    {
        private readonly SessionsDbContext context;

        public SessionsRepository(SessionsDbContext context)
        {
