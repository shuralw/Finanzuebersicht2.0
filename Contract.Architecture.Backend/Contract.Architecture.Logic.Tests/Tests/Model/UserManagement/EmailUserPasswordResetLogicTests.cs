...
namespace Contract.Architecture.Logic.Tests.Model.Users.EmailUser
{
    [TestClass]
    public class EmailUserPasswordResetLogicTests
    {
        ...
        public void InitializePasswordResetTest()
        {
            ...
            Mock<IEmailUserPasswordResetTokenRepository> emailUserPasswordResetTokenRepository = this.SetupEmailUserPasswordResetTokenRepositoryDefault();
        ...
        {
            // Arrange
            Mock<IEmailUserPasswordResetTokenRepository> emailUserPasswordResetTokenRepository = this.SetupEmailUserPasswordResetTokenRepositoryExpired();
            Mock<IDateTimeService> dateTimeService = this.SetupDateTimeServiceDefault();
        ...
        {
            // Arrange
            Mock<IEmailUserPasswordResetTokenRepository> emailUserPasswordResetTokenRepository = this.SetupEmailUserPasswordResetTokenRepositoryNotFound();
        ...
        private Mock<IEmailUserPasswordResetTokenRepository> SetupEmailUserPasswordResetTokenRepositoryDefault()
        {
            Mock<IEmailUserPasswordResetTokenRepository> emailUserPasswordResetTokenRepository = new Mock<IEmailUserPasswordResetTokenRepository>(MockBehavior.Strict);
        ...
        private Mock<IEmailUserPasswordResetTokenRepository> SetupEmailUserPasswordResetTokenRepositoryExpired()
        {
            Mock<IEmailUserPasswordResetTokenRepository> emailUserPasswordResetTokenRepository = new Mock<IEmailUserPasswordResetTokenRepository>(MockBehavior.Strict);
        ...
        private Mock<IEmailUserPasswordResetTokenRepository> SetupEmailUserPasswordResetTokenRepositoryNotFound()
        {
            Mock<IEmailUserPasswordResetTokenRepository> emailUserPasswordResetTokenRepository = new Mock<IEmailUserPasswordResetTokenRepository>(MockBehavior.Strict);
