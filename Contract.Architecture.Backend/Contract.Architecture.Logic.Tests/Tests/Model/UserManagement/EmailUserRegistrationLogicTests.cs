...
namespace Contract.Architecture.Logic.Tests.Model.Users.EmailUser
{
    ...
    public class EmailUserRegistrationLogicTests
    {
        ...
        public void RegisterConflictTest()
        {
            ...
            var logger = Mock.Of<ILogger<EmailUserRegistrationLogic>>();

            EmailUserRegistrationLogic emailUserRegistrationLogic = new EmailUserRegistrationLogic(
            ...
            // Act
            var result = emailUserRegistrationLogic.Register(Email, Password);
