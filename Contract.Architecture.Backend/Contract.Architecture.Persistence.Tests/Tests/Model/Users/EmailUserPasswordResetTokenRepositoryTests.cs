...
using Contract.Architecture.Persistence.Tests.Mocking;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using System;

namespace Contract.Architecture.Persistence.Tests.Model.Users
{
    [TestClass]
    public class EmailUserPasswordResetTokenRepositoryTests
    {
        ...
        public void CreateTokenAndGetTokenTest()
        {
            ...
            EmailUserPasswordResetTokenRepository emailUserPasswordResetTokenRepository = repos.GetEmailUserPasswordResetTokenRepository();
