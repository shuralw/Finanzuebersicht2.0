...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        {
            ...
            ILogicResult<Contract.Logic.Modules.SessionManagement.Sessions.ISession> validationResult = this.sessionsLogic.GetSessionFromToken(token);
            ...
            Contract.Logic.Modules.SessionManagement.Sessions.ISession session = validationResult.Data;
        ...
        private AuthenticationTicket CreateAuthenticationTicketFromValidSession(Contract.Logic.Modules.SessionManagement.Sessions.ISession session)
        {
        ...
        private List<Claim> GenerateClaimsFromSession(Contract.Logic.Modules.SessionManagement.Sessions.ISession session)
        {
