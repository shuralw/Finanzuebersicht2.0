...
namespace Finanzuebersicht.Backend.Core.Persistence.Modules.Accounting.AccountingEntries
{
    internal class DbAccountingEntryListItem : IDbAccountingEntryListItem
    {
        ...
        internal static IDbAccountingEntryListItem FromEfAccountingEntry(EfAccountingEntry efAccountingEntry)
        {
            ...
            return new DbAccountingEntryListItem()
            {
