...
import { CategoryUpdateDialog } from './dialogs/category-update/category-update.dialog';
import { CategoryDetailPage } from './sub-pages/category-detail/category-detail.page';
